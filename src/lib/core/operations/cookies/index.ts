...
export const set_operation: Operation = async (cookie: Record<string, Any>, { context, app, previousResult }) => {
...
export const unset_operation: Operation = async (cookie: string, { context, app, previousResult }) => {
