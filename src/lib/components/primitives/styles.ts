export const Typography = {
    h1: 'text-6xl font-bold mb-4 mt-12 first:mt-0',
    h2: 'text-4xl font-bold mb-4 mt-12 first:mt-0',
    h3: 'text-2xl font-bold mb-3 mt-12 first:mt-0',
    h4: 'text-xl font-bold mb-3 mt-12 first:mt-0',
    h5: 'text-lg font-bold mt-12 first:mt-0',
    h6: 'text-xs uppercase font-bold mt-12 first:mt-0',
